import commonBinarySearch from "./write"
...
describe("Binary search algorithm", () => {
    ...
    it.skip("should find the max number in mirror array", () => {
    ...
    it.skip("should find the max number in rotated array", () => {
    ...
    it.skip("should find the min number in rotated array", () => {
